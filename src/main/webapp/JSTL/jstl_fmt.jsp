...
<body>
	...
	<fmt:parseDate var="date" value="${TIME_A}" pattern="yyyy/MM/dd"/>
	<fmt:formatDate value="${date}" pattern="yyyy년 MM월 dd일"/><br>
	
	<fmt:parseDate var="date02" value="${TIME_C}" pattern="yyyy-MM-dd HH:mm:ss"/>
	<fmt:formatDate value="${date02}" pattern="yyyy년 MM월 dd일"/><br>
